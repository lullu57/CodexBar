...
extension StatusItemController {
    ...
    func reconcileMenuContent(
        ...
        shapes: [MenuRowShape],
        with scratch: NSMenu,
        preserveNativeImageRows: Bool = false)
    {
        ...
        func updatable(_ shape: MenuRowShape, _ newItem: NSMenuItem) -> Bool {
            ...
            if !preserveNativeImageRows,
               shape.requiresNativeImageReplacement || self.shouldReplaceNativeImageItemDuringReconcile(newItem)
            {
                return false
            }
        ...
        if preserveNativeImageRows,
           ...
           let firstNewItem = newItems.first,
           !firstShape.isSeparator,
           !firstNewItem.isSeparatorItem
        {
            self.updateMenuItemInPlace(menu.items[fromIndex], from: firstNewItem)
            prefix = 1
        }
        ...
        -> [NSMenuItem]
    {
        ...
        for offset in 0..<sharedCount {
            ...
            let requiresNativeImageReplacement = !preserveNativeImageRows && (
